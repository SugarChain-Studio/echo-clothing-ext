...
export default function () {
    ...
    const func = (args, _) => {
        ...
        if (AssetManager.assetIsCustomed(asset)) {
            ...
            DrawImageResize(img, iconX, iconY, iconSize, iconSize);
    ...
    const iconDiv = makeTooltipIcon(ModInfo.name, hamburgerIcon);
