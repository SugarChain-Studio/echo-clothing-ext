...
const asset = {
    ...
    Layer: [
        ...
        { Name: "Sive", AllowTypes: { l: 30 } },
        { Name: "月", AllowTypes: { l: 31 } },
        { Name: "er", AllowTypes: { l: 32 } },
        {
            Name: "Personas",
            PoseMapping: specialMapping,
            AllowTypes: { l: 33 },
        },
        { Name: "Soph", AllowTypes: { l: 34 } },
        { Name: "羽", AllowTypes: { l: 35 } },
        { Name: "Milim", AllowTypes: { l: 36 } },
        { Name: "爱丽丝梦游仙境", AllowTypes: { l: 37 } },
